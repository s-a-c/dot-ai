...
After measuring satisfaction metrics, proceed to the [Refinement](ai/700-r-and-d%201/ume/030-ume-tutorial/180-quality-assurance/030-refinement/000-index.md) section to learn how to improve the documentation based on the feedback gathered during user testing.
