...
Edit the migrations according to the [Migration Patterns](050-common-patterns-snippets.md#migration-patterns) in the cheat sheet, then run:
...
Implement the tests according to the [Testing Patterns](050-common-patterns-snippets.md#testing-patterns) in the cheat sheet.
