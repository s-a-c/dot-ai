...
1. **Introduction to UME** (2 hours)
   ...
   - [Learning Objectives](030-learning-objectives.md)
...
2. **Prerequisites** (4 hours)
   ...
   - Complete the [Prerequisites Exercises](020-prerequisites-exercises.md)

3. **PHP 8 Attributes Basics** (3 hours)
   - [PHP 8 Attributes Introduction](060-php8-attributes.md)
...
10. **Troubleshooting Common Issues** (4 hours)
    - [Foundation Troubleshooting](010-phase0-foundation-troubleshooting.md)
    - [Core Models Troubleshooting](020-phase1-core-models-troubleshooting.md)
    - [Auth & Profiles Troubleshooting](030-phase2-auth-profile-troubleshooting.md)
...
2. Exploring the [Teams & Permissions](ai/700-r-and-d%201/ume/030-ume-tutorial/050-implementation/040-phase3-teams-permissions/000-index.md) section
