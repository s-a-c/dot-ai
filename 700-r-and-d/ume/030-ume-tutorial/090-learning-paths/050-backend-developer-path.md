...
9. **Two-Factor Authentication** (6 hours)
   ...
   - [2FA Security Considerations](020-authentication-security.md#two-factor-authentication)
...
10. **State Machines** (8 hours)
    ...
    - Complete the [State Machine Exercises](040-050-state-machine-exercises.md) (All sets)
...
13. **Team Hierarchy and State** (6 hours)
    ...
    - Complete the [Team Hierarchy Exercises](040-080-team-hierarchy-state-machine-exercises.md) (All sets)
...
16. **API Security** (6 hours)
    - [API Security Best Practices](070-api-security.md)
    - [Rate Limiting](070-api-security.md#rate-limiting)
    - [Input Validation](070-api-security.md#input-validation)
...
20. **Security Implementation** (8 hours)
    ...
    - [SQL Injection Prevention](060-sql-injection-prevention.md)
