...
- **[000-index.md](ai/300-aureuserp/200-junie/020-package-analysis/000-index.md)**: Main index file with table of contents and navigation
- **[010-composer-packages.md](010-composer-packages.md)**: Documentation for PHP/Composer packages
- **[020-node-packages.md](020-node-packages.md)**: Documentation for Node.js packages
- **[030-configuration-best-practices.md](030-configuration-best-practices.md)**: General configuration best practices
...
1. Start with the [index file](ai/300-aureuserp/200-junie/020-package-analysis/000-index.md) to get an overview of the content
