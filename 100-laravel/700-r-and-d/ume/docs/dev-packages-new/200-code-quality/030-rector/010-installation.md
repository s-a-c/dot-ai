...
1. Review the [Configuration](ai/100-laravel%201/700-r-and-d/ume/docs/dev-packages-new/200-code-quality/030-rector/020-configuration.md) guide for advanced settings
2. Learn about [Laravel-specific rules](ai/100-laravel%201/700-r-and-d/ume/docs/dev-packages-new/200-code-quality/030-rector/030-laravel-rules.md)
