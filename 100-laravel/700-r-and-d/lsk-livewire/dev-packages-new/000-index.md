...
| [Templates](ai/guidelines/130-templates/000-index.md) | Documentation templates | Package, Category, Configuration |
...
- [Implementation Plan](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/005-project-docs/010-implementation-plan.md)
- [Progress Tracker](005-project-docs/015-progress-tracker.md)
- [Completion Report](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/005-project-docs/020-completion-report.md)
...
- [Laravel Pint](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/200-code-quality/020-pint.md) - Code style fixer
- [Rector](200-code-quality/030-rector/000-index.md) - Automated refactoring tool
- [PHP Insights](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/200-code-quality/040-phpinsights.md) - Code quality metrics
- [PHP Parallel Lint](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/200-code-quality/050-parallel-lint.md) - Fast PHP linter
- [Laravel Blade Comments](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/200-code-quality/060-blade-comments.md) - Blade template comments
- [Security Advisories](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/200-code-quality/070-security-advisories.md) - Security vulnerability checking

## 7. Debugging Packages

The [Debugging Packages](300-debugging/000-index.md) section covers all debugging-related packages:

- [Laravel Debugbar](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/010-debugbar.md) - Performance and debugging toolbar
- [Ray](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/020-ray.md) - Debug with Ray app
- [Laravel Pail](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/030-pail.md) - Log viewer
- [Laravel Telescope](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/040-telescope.md) - Debug assistant
- [Horizon Watcher](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/050-horizon-watcher.md) - Queue monitoring
- [Web Tinker](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/300-debugging/060-web-tinker.md) - In-browser REPL
...
- [Laravel Sail](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/400-dev-environment/010-sail.md) - Docker development environment
- [Peck PHP](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/400-dev-environment/020-peck.md) - PHP development server
- [Solo](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/400-dev-environment/030-solo.md) - Development environment tool
- [Composer Normalize](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/400-dev-environment/040-composer-normalize.md) - Composer file normalizer
...
- [Eloquent Model Generator](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/500-code-generation/010-eloquent-model-generator.md) - Generate Eloquent models from database
- [Laravel IDE Helper](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/500-code-generation/020-ide-helper.md) - Generate IDE helper files
...
- [Collision](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/600-utilities/010-collision.md) - Error reporting tool
- [Faker](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/600-utilities/020-faker.md) - Test data generation
- [Var Dumper](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/600-utilities/030-var-dumper.md) - Variable inspection
- [Polyfill PHP 8.4](ai/100-laravel%201/700-r-and-d/lsk-livewire/dev-packages-new/600-utilities/040-polyfill-php84.md) - PHP 8.4 features in lower PHP versions
...
The [Templates](ai/guidelines/130-templates/000-index.md) directory contains templates for creating documentation for development packages:
