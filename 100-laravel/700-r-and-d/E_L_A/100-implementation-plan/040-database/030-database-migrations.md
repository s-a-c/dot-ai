...
- [In-Memory SQLite Database](020-in-memory-database.md) completed
...
- [Database Setup](010-database-setup.md) - For general database setup and configuration
- [In-Memory SQLite Database](020-in-memory-database.md) - For configuring in-memory databases
- [Security Setup](010-security-setup.md) - For security considerations in database design
...
**Previous Step:** [In-Memory SQLite Database](020-in-memory-database.md) | **Next Step:** [Security Setup](010-security-setup.md)
