...
- [Filament Configuration](040-filament-configuration.md) completed
...
- [Filament Configuration](040-filament-configuration.md) - For setting up the frontend components
- [In-Memory SQLite Database](020-in-memory-database.md) - For configuring a single SQLite in-memory database for
  all persistence, caching, and queueing
- [Database Migrations](030-database-migrations.md) - For setting up database migrations
- [Final Configuration](020-final-configuration.md) - For final configuration steps
...
**Previous Step:** [Filament Configuration](040-filament-configuration.md) | **Next Step:**
[In-Memory SQLite Database](020-in-memory-database.md)
