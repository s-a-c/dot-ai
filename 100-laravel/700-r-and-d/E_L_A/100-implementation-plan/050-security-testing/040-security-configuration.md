...
- [Custom AppServiceProvider](010-app-service-provider.md) - For AppServiceProvider configuration
- [Final Configuration](020-final-configuration.md) - For final configuration steps
- [Laravel Sanctum Setup](050-sanctum-setup.md) - For API authentication
...
**Previous Step:** [Custom AppServiceProvider Configuration](010-app-service-provider.md) | **Next Step:** [Final Configuration and Verification](020-final-configuration.md)
