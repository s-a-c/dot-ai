...
- [Database Migrations](030-database-migrations.md) completed
...
2. Configure cookie security in `config/sanctum.php`:
   ...
   > **Note:** For detailed Sanctum setup instructions, see [Laravel Sanctum Setup](050-sanctum-setup.md)
...
- [Database Migrations](030-database-migrations.md) - For database setup and migrations
- [Laravel Sanctum Setup](050-sanctum-setup.md) - For detailed Sanctum setup instructions
- [Security Configuration Details](040-security-configuration.md) - For advanced security configuration
...
**Previous Step:** [Database Migrations](030-database-migrations.md) | **Next Step:** [Testing Environment Setup](020-testing-setup.md)
